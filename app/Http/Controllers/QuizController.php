...
class QuizController extends Controller
{
    ...
    public function store()
    {
        $quizAttributes = request()->validate([
            ...
            'thumbnail' => 'image|max:2048|dimensions:min_width=200,min_height=200',
        ...
        if (request()->hasFile('thumbnail')) {
            ...
            $thumbnailPath = $thumbnail->move(public_path('quizzes'), $thumbnail->getClientOriginalName());
            $quizAttributes['thumbnail'] =  $thumbnail->getClientOriginalName();
        }
    ...
    public function update(Quiz $quiz)
    {
        ...
        if (request()->hasFile('thumbnail')) {
            // Xóa ảnh cũ nếu có
            if ($quiz->thumbnail) {
                $oldThumbnailPath = public_path($quiz->thumbnail);
